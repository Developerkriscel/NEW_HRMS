...
export function CameraVerificationModal({ isOpen, onClose, onConfirm, locationRequired = false, title = "Verify Attendance" }) {
  ...
  return (
    <Portal><div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="max-h-[90dvh] overflow-y-auto bg-white dark:bg-slate-900 w-full max-w-md rounded-2xl shadow-2xl overflow-hidden flex flex-col border border-slate-200 dark:border-slate-800 animate-in zoom-in-95 duration-200">
        ...
        {/* Content */}
        <div className="p-6 flex-1 flex flex-col items-center justify-center min-h-[400px] bg-slate-50 dark:bg-slate-900/50">
          {error ? (
            ...
            <div className="w-full flex flex-col items-center animate-in fade-in zoom-in-95 duration-300">
              <div className="relative w-64 h-64 rounded-full overflow-hidden border-4 border-indigo-500 shadow-xl mb-6">
            ...
            <div className="w-full flex flex-col items-center">
              <div className="relative w-72 h-72 rounded-full overflow-hidden bg-slate-900 border-4 border-white dark:border-slate-800 shadow-2xl mb-8 group">
                <video 
                  ref={(node) => {
