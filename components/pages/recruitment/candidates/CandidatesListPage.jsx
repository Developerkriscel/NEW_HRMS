...
import { Eye, FileText, ArrowRightLeft, MessageSquarePlus, ChevronLeft, ChevronRight, Users } from 'lucide-react'
...
export function CandidatesListPage() {
  ...
  const [filters, setFilters] = useState({ job: '', source: '', status: '', search: '' })
  ...
  function clearFilters() {
    setPage(0)
    setFilters({ job: '', source: '', status: '', search: '' })
  }
    ...
    <div className="animate-fade-in space-y-6">
      ...
      <div className="stat-card !p-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
          <input className="input-field" placeholder="Search name, email, phone..." value={filters.search} onChange={(e) => updateFilter('search', e.target.value)} />
                ...
                <tbody>
                  {rows.map((r) => (
                    <tr key={r.applicationId}>
                      ...
                      <td className="max-w-[160px] truncate" title={r.jobTitle}>{r.jobTitle}</td>
                      ...
                      <td className="whitespace-nowrap">{formatDate(r.appliedAt)}</td>
                      ...
                      <td>
                        <div className="flex gap-0.5">
                          ...
                          <Link href={`/hr/recruitment/applications/${r.applicationId}`} title="View Application" className="p-1 rounded-lg text-slate-400 hover:text-blue-600 hover:bg-blue-50 dark:hover:bg-blue-900/20">
